...
class <?php echo $helper->className() ?> extends <?php echo $helper->parentClassName() ?> {
	...
	protected function readAncodesMap($info) {
		...
		$offset = isset($info['ancodes_map_offset']) ?
			...
			$info['offset'] + <?php echo $helper->getInfoHeaderSize() ?> + $info['forms_count'] * 2;
	...
	function readAncodes($info) {
		...
		$offset = isset($info['ancodes_offset']) ?
			$info['ancodes_offset'] :
			$info['offset'] + <?php echo $helper->getInfoHeaderSize() ?>;
	...
	function readFlexiaData($info) {
		...
		$offset = isset($info['affixes_offset']) ?
			$info['affixes_offset'] :
			$info['offset'] + <?php echo $helper->getInfoHeaderSize() ?> + $info['forms_count'] * 2 + $info['packed_forms_count'] * 2;
